...
describe("Date formatter utility function test suite", () => {
    ...
    test("testing same day date (AM)", () => {
        const nowDate = new Date("2022-04-15T12:00:00+07:00");
        const beforeDate = new Date("2022-04-15T11:00:00+07:00");
        const formattedDate = dateFormatter(beforeDate, nowDate);
        
        expect(formattedDate).toBe("11:00 AM");
    })
    test("testing same day date (PM)", () => {
        const nowDate = new Date("2022-04-15T23:00:00+07:00");
        const beforeDate = new Date("2022-04-15T22:00:00+07:00");
        const formattedDate = dateFormatter(beforeDate, nowDate);
    ...
    test("testing different day but within 24 hours date", () => {
        const nowDate = new Date("2022-04-16T00:00:00+07:00");
        const beforeDate = new Date("2022-04-15T23:00:00+07:00");
        const formattedDate = dateFormatter(beforeDate, nowDate);
